...
export default antfu(
  {
    ...
    nextjs: true,
    typescript: true,
    jsdoc: false, // Use our own jsdoc config below so plugin and rules live in same config
  ...
  // --- JSDoc (plugin + rules in one config so overrides can reference jsdoc/ rules) ---
