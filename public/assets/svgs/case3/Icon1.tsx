...
const Icon1 = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg {...props} width="80" height="83" viewBox="0 0 80 83" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="80" height="80" rx="8" fill="#05061A" fillOpacity="0.4" />
      <rect x="0.5" y="0.5" width="79" height="79" rx="7.5" stroke="url(#paint0_linear_44_2236)" strokeOpacity="0.2" />
      <g filter="url(#filter0_d_44_2236)">
        <rect x="12" y="12" width="56" height="56" rx="4" fill="url(#paint1_linear_44_2236)" shapeRendering="crispEdges" />
      ...
      <defs>
        <filter id="filter0_d_44_2236" x="0.203377" y="0.203377" width="79.5932" height="79.5932" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
          ...
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_44_2236" />
          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_44_2236" result="shape" />
        </filter>
        <linearGradient id="paint0_linear_44_2236" x1="0" y1="0" x2="40" y2="80" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF5B35" />
          <stop offset="1" stopColor="#490E00" />
        </linearGradient>
        <linearGradient id="paint1_linear_44_2236" x1="12" y1="12" x2="40" y2="68" gradientUnits="userSpaceOnUse">
